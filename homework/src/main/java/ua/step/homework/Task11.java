...
public class Task11 {
    public static void main(String[] args) {
        ...
        System.out.print(secondsToNewYear/86400+" дней"+", "+(secondsToNewYear%86400)/3600+" часов"+", "+((secondsToNewYear%86400)%3600)/60+" минут"+" и "+(((secondsToNewYear%86400)%3600)%60)+" секунд");
